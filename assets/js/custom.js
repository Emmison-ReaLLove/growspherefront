      ...
      new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Referrals",
              data: data.referralCount,
              borderColor: "blue",
              fill: false,
            },
            {
              label: "Daily Earnings",
              data: data.dailyEarning,
              borderColor: "green",
              fill: false,
            },
            {
              label: "All-Time Earnings",
              data: data.allTimeEarning,
              borderColor: "orange",
              fill: false,
            },
          ],
...
/* const resetLocalStorage = () => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      claimBtn.addEventListener("click", async () => {
        try {
          const response = await fetch("/claim-daily-task", {
            method: "POST",
            headers: {
          ...
          setTimeout(() => {
            window.location.href = "https://chat.whatsapp.com/EqPaCBNtoE8JL7ii52EUAe"; // Change to your desired URL
          }, 2000);
        } catch (error) {
